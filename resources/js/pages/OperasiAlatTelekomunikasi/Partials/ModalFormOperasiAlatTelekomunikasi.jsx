...
/**
 * Komponen modal form untuk data sarana alat telekomunikasi.
 *
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <TextInput
              ...
              onChange={handleInputChange}
              disabled={processing}
              error={Boolean(errors.jenis_perangkat)}
              helperText={errors.jenis_perangkat}
            />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <TextInput
              ...
              onChange={handleInputChange}
              disabled={processing}
              error={Boolean(errors.harga_perolehan)}
              helperText={errors.harga_perolehan}
            />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <TextInput
              ...
              id="rentang_frekuensi"
              value={formData.rentang_frekuensi}
              onChange={handleInputChange}
              disabled={processing}
              error={Boolean(errors.rentang_frekuensi)}
              helperText={errors.rentang_frekuensi}
            />
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <TextInput
              ...
              name="teknologi_digital"
              id="teknologi_digital"
              value={formData.teknologi_digital}
              onChange={handleInputChange}
              disabled={processing}
              error={Boolean(errors.teknologi_digital)}
              helperText={errors.teknologi_digital}
            />
          </Grid>
...
export default ModalFormOperasiAlatTelekomunikasi;
