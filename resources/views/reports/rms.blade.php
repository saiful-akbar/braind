<x-layouts.sarana-operasi title="Rekapitulasi Monitoring Sarana Operasi (RMS)">
    ...
    <section class="table-container" id="operasiKapalPatroli">
    ...
    <section class="table-container" id="operasiAlatTelekomunikasi">
    ...
    <section class="table-container" id="operasiSenjataApi">
    ...
    <section class="table-container" id="operasiAlatPemindai">
    ...
    <section class="table-container" id="operasiLainnya">
