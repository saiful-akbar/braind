<x-layouts.sarana-operasi title="Laporan Pengoperasian Sarana Operasi (LPSO)">
    ...
    <x-slot:jenis-laporan>
        LAPORAN PENGOPERASIAN SARANA OPERASI (LPSO) <br />
        BULAN {{ strtoupper($bulan_pelaporan) }} TAHUN {{ $tahun_pelaporan }}
    </x-slot:jenis-laporan>

    <section id="kapalPatroli" class="table-container">
        <div class="table-title">A. PENGOPERASIAN KAPAL PATROLI</div>
    ...
    <section id="alatTelekomunikasi" class="table-container">
        <div class="table-title">B. PENGOPERASIAN ALAT TELEKOMUNIKASI</div>
    ...
    <section id="senjataApi" class="table-container">
        <div class="table-title">C. PENGOPERASIAN SENJATA API</div>
    ...
    <section id="alatPemindai" class="table-container">
        <div class="table-title">D. PENGOPERASIAN ALAT PEMINDAI DAN PENDETEKSI</div>
    ...
    <section id="lainnya" class="table-container">
        <div class="table-title">E. PENGOPERASIAN SARANA OPERASI LAINNYA</div>
