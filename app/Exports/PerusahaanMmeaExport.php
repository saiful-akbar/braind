...
class PerusahaanMmeaExport implements FromView, WithStyles, ShouldAutoSize
{
    use Exportable;
    ...
    public function __construct(private Request $request, private MenuUser $access)
    {
        ...
        $this->query = PerusahaanMmea::select($columns)
    ...
    function view(): View
    {
        return view('exports.perusahaan-mmea-export', [
            'data' => $this->query->get(),
        ]);
    }
}
