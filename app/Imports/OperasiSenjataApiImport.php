...
class OperasiSenjataApiImport implements ToModel, WithHeadingRow, WithValidation
{
    ...
    public function rules(): array
    {
        return [
            ...
            'jenis_kaliber'            => 'required|max:30',
            'nomor_senjata'            => 'required|max:30',
            'nama_pemegang_senjata'    => 'required|max:50',
            'pangkat_pemegang_senjata' => 'required|max:50',
            'jabatan_pemegang_senjata' => 'required|max:50',
            'nomor_buku_pas'           => 'required|max:30',
